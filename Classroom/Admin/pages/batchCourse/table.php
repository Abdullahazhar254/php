                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <a href="insert.php"><input type="submit" value="Add New Batch Course" class="btn btn-success"/></a><br><br>
                                            ...
                                            if(mysqli_num_rows($result1) > 0){
                                                while($row = mysqli_fetch_array($result1)){
                                                    echo "<tr>";
                                                        ...
                                                        echo "<td>";
                                                            echo "<a href='update.php?id=". $row['bcf_id'] ."'><input type='submit' value='Update' class='btn btn-info'/></a>&nbsp&nbsp";
                                                            echo "<a href='delete.php?id=". $row['bcf_id'] ."'><input type='submit' value='Delete' class='btn btn-danger'/></a>";
                                                        echo "</td>";
                                                    echo "</tr>";
                                                }
                                            } 
