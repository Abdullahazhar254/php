...
$queryf = "SELECT bcf.bcf_id,c.c_name FROM batchcf bcf JOIN course c ON bcf.bcf_courseId = c.c_id WHERE bcf.bcf_facultyId = '$faculty_id'";
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <?php
                        if ($try=="/classroom/Faculty/pages")
                        {
                            ?>
                            <a class="navbar-brand" href="FacultyDash.php">My Classroom</a>
                            <?php
                        }else if($try=="/classroom/Faculty/pages/Lecture"||$try=="/classroom/Faculty/pages/assignment"||$try=="/classroom/Faculty/pages/quiz"||$try=="/classroom/Faculty/pages/quizquestion")
                        {
                            ?>
                <a class="navbar-brand" href="../FacultyDash.php">My Classroom</a>            
                            <?php
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
                    ...
                    <li>
                        ...
                        <?php
                                    while($rowf = mysqli_fetch_array($resultf)){
                                        ...
                                        if ($try=="/classroom/Faculty/pages")
                                        {
                                            echo "<a href='Gallery.php?id=" .$rowf['bcf_id']."' > " .$rowf['c_name']. " </a>";
                                        }else if($try=="/classroom/Faculty/pages/Lecture"||$try=="/classroom/Faculty/pages/assignment"||$try=="/classroom/Faculty/pages/quiz"||$try=="/classroom/Faculty/pages/quizquestion")
                                        {
                                            echo "<a href='../Gallery.php?id=" .$rowf['bcf_id']."' > " .$rowf['c_name']. " </a>";
                                        }
            ...
            <div class="legal">
                <div class="copyright">
                <?php
                                if ($try=="/classroom/Admin/pages")
                                {
                                    ?>
                                    &copy; 2020 <a href="FacultyDash.php">My Classroom</a>.
                                    <?php
                                }else if($try=="/classroom/Admin/pages/batch"||$try=="/classroom/Admin/pages/batchCourse"||$try=="/classroom/Admin/pages/course"||$try=="/classroom/Admin/pages/faculty"||$try=="/classroom/Admin/pages/student")
                                {
                                    ?>
                                    &copy; 2020 <a href="../FacultyDash.php">My Classroom</a>.            
                                    <?php
