...
if (isset($_POST['login']))
{
    ...
    $select1="SELECT * FROM admin WHERE ad_email='$username' OR ad_lname='$username' AND ad_password='$password'";
    $run1=mysqli_query($link, $select1);
    if ($run1) { 
        $row1=mysqli_fetch_row($run1);
        $_SESSION['adid']=$row1[0];
        $_SESSION['adname']=$row1[1];
        echo 'Successfull';
        header("location: Admin/pages/AdminDash.php");
    }else{
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    <div class="msg">Admin Signin</div>
